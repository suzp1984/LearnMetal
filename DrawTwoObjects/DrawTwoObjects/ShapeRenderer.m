...
@implementation ShaperRenderer
{
    ...
    id<MTLRenderPipelineState> _squarePipelineState;
...
- (nonnull instancetype) initWithMetalKitView:(nonnull MTKView*)mtkView
{
    ...
    if (self) {
        ...
        _squarePipelineState = [_device newRenderPipelineStateWithDescriptor:pipelineStateDescriptor error:&error];
        
        NSAssert(_squarePipelineState, @"Failed to create square pipeline state: %@", error);
        
        _trianglePipelineState = [_device newRenderPipelineStateWithDescriptor:pipelineStateDescriptor error:&error];
        
        NSAssert(_trianglePipelineState, @"Failed to create triangle pipeline state: %@", error);
...
//        _squareUniform.viewMatrix = matrix4x4_rotation(PI / 6.0, 0.0, 0.0, 1.0);
...
- (void)drawInMTKView:(nonnull MTKView *)view
{
    ...
    [squareRenderEncoder setRenderPipelineState:_squarePipelineState];
    ...
    [triangleRenderEncoder setRenderPipelineState:_trianglePipelineState];
