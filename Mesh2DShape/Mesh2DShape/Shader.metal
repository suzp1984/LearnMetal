...
{
    float2 position [[attribute(ModelVertexAttributePosition)]];;
} Vertex;
...
vertex RasterizerData vertexShader(Vertex in [[stage_in]],
    ...
    out.position = uniform.projectionMatrix * uniform.viewMatrix * uniform.modelMatrix * float4(in.position, 0.0, 1.0);
